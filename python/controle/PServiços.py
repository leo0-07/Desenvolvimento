...
class Serviço:
    def __init__(self):
        self.Info=dStorage(("0","manutenção","sistema","1046910458","instalação Debian/Linux","12/06/2018","20/06/2018","100,00"),("id","categoria","tipo","id_cliente","nome", "data_de_entrada", "previsão_de_entrega","valor"))
        self.Info.setdb("Dados","Serviços")
        self.Info.l_pdindex()
        self.cli = Person
        self.wnd = tk.Tk()
